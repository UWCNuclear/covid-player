#ifndef d2full_model_H
#define d2full_model_H
...
class d2full_model : public fitmodel
{
    RQ_OBJECT("d2full_model");
...
public:
    d2full_model(const TGCompositeFrame *MotherFrame, UInt_t w, UInt_t h, covid_viewer *main = nullptr);
    virtual ~d2full_model();

    virtual void InitParameters();
    virtual Double_t FitFunction(Double_t*/*xx*/,Double_t*/*pp*/);


    ClassDef(d2full_model,0);
};
